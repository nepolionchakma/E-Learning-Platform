...
/**
 * Renders terminal code blocks from item.code
 * Parses prompt-based format and creates command/output pairs
 */
...
/**
 * Renders individual content items (code, text, tables)
 */
 ...
 * Provides sidebar TOC, hero section, and responsive design
 */
